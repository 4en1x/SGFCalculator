                ...
                <View style={{ flex: 1 }}>
                    ...
                    >
                        ...
                        <VictoryGroup domain={{ y: [0, Global.maxY * 1.2] }} >
                            ...
                            <VictoryLabel
                                text="CURRENT"
                                datum={{ x: Global.current_data[Math.round(Global.current_data.length / 2)].x, y: firstDestination }}
                                textAnchor="start" style={{ stroke: '#ffffff' }}
                            />
                            <VictoryLabel
                                text="ALTERNATIVE"
                                datum={{ x: Global.sgf_data[Math.round(Global.current_data.length / 2)].x, y: secondDestination }}
                                textAnchor="start" style={{ stroke: '#ffffff' }}
                            />
                        </VictoryGroup>
                    </VictoryChart>
